...
CFLAGS = -std=c23 -ffp-contract=fast -ffast-math -g -Wall -pedantic -Werror -Wextra -Wno-newline-eof -Wno-unsequenced -Wno-return-stack-address -Wno-format-pedantic
